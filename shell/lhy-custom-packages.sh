...
# 集客AC
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES gecoosac luci-app-gecoosac"
# 任务设置
...
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES v2ray-geoip"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES v2ray-geosite"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES v2dat"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-passwall"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-passwall-zh-cn"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES nikki"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-nikki"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-nikki-zh-cn"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES mosdns"
